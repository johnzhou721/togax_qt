...
This package is originally part at https://github.com/CabbageDevelopment/qasync,
licensed under the BSD license;
It is vendored and modified into this project since the original was unmaintained
in two year, in order to remove references to the to-be-deprecated event loop
policy feature of asyncio; for simplification, it also removes the run function,
since we can do run_until_complete on an event loop anyways.
